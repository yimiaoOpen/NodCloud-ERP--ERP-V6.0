            ...
            layer.open({
                ...
                btn1: function(layero) {
                    ...
                    if (reg_test('empty',info['name'])) {
                        ...
                        //提交信息
                        info['id']=id;
                        ajax('POST','/index/unit/set_unit',info,function(resule){

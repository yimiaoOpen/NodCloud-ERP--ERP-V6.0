layui.use('table', function() {
    ...
    table.render({
        ...
        url: '/index/plug/more?plug_info=formmore/main/form_list',
        page: true,
        limit: 30,
        ...
        layer.ready(function() {
            layer.open({
                ...
                success: function(layero, index) {
                    ...
                    //获取信息
                    if (id > 0) {
                        ajax('POST','/index/plug/more?plug_info=formmore/main/get_info',{
                            "id": id
                        },function(resule){
                ...
                btn1: function(layero) {
                    ...
                    if (reg_test('empty',info['name'])) {
                        ...
                        //提交信息
                        info['id']=id;
                        ajax('POST','/index/plug/more?plug_info=formmore/main/set',info,function(resule){
...
function delect(info){
    layui.use(['layer','table'], function() {
        layer.confirm('您确定要删除所选数据吗？', {
            ...
            //发送请求
            ajax('POST','/index/plug/more?plug_info=formmore/main/del_info',{
                "arr": arr
            },function(resule){
                if(resule.state=='success'){
                    search();
